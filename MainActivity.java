package com.example.anand_kumar.firstapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onYesClickButton(View view) {
        String userName = String.valueOf(userNameEditText.getText());

        String yourYesResponce = "That is Great " + userName;

        Toast.makeText(this,yourYesResponce, Toast.LENGTH_SHORT).show();

    }

    public void onNoClickButton(View view) {

        String userName = String.valueOf(userNameEditText.getText());

        String yourNoResponce = "To Bad " + userName;

        Toast.makeText(this,yourNoResponce, Toast.LENGTH_LONG).show();
